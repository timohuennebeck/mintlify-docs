...
<Tip>
    For images and videos, it's recommended to use cloud-hosted URLs rather than including them directly in
    the repository. This helps keep the repository size small and manageable.
</Tip>
