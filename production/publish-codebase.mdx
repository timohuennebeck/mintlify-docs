...
<Steps>
    ...
    <Step title="Creating a Project + Importing (`.env`) Variables">
        <video
            ...
            src="https://www.dropbox.com/scl/fi/aoh9lo3gdldushnclno4i/deploy-project.mp4?rlkey=627ccn8w9vxmylwh6cod3ne1l&st=yec3a5im&raw=1"
        ></video>
    ...
    <Step title="Connecting Your Domain">
        ...
        <video
            ...
            playsInline
            className="w-full aspect-video"
            src="https://www.dropbox.com/scl/fi/z5ms510mx7cq0eo6hbdhz/add-domain.mp4?rlkey=rdhkqb2ghca86ovpqo5htexzj&st=f82f58ah&raw=1"
        ></video>
    </Step>
